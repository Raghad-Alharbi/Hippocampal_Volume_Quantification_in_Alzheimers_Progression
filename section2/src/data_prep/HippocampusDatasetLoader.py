...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # ANSWER: Labels are float-64 type. However, it takes only 3 unique values: 0, 1, 2,
        # and We will use labels as classs (categorical), and integer values are easier to work with. 
