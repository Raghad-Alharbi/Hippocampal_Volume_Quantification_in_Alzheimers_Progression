...
def get_series_for_inference(path):
    ...
    for i, dicom in enumerate(dicoms):
        if dicom.Modality in ['MR', 'CT']:
            if dicom.SeriesDescription=='HippoCrop':
                series_for_inference.append(dicom)
                print ("YES: DICOM:", i, ", Modality:", dicom.Modality, ", Description:", dicom.SeriesDescription, ", Rows:" , dicom.Rows)
            else:
                print("DICOM:", i, ", Modality:", dicom.Modality, ", Description:", dicom.SeriesDescription, ", Rows:" , dicom.Rows)
        else:
            print("DICOM:", i, ", Modality:", dicom.Modality, ", Rows:", dicom.Rows)
...
if __name__ == "__main__":
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"results/model.pth")
    ...
    report_save_path = r"/home/workspace/out/reports/report.dcm"
